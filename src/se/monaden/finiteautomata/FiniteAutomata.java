 ...
 */
package se.monaden.finiteautomata;

import se.monaden.finiteautomata.base.exceptions.LanguageException;
import se.monaden.finiteautomata.gui.MainFrame;
import java.io.File;
...
//        new FiniteAutomata();
    ...
    public static void testFA() throws LanguageException {
        ...
        states.put(q3.name(),q3);
        states.put(q4.name(),q4);
        states.put(q5.name(),q5);
        ...
        MainFrame.graphicsPanel.setFa(dfa);
    }
//    
